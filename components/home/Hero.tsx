...
export default function Hero() {
  ...
  return (
    <section
      className="relative flex min-h-[calc(100vh-64px)] items-center overflow-hidden bg-cover bg-center px-4 pb-10 pt-12 md:px-8 md:pb-16 md:pt-20"
      style={{
        backgroundImage:
          "url(https://images.unsplash.com/photo-1607934468854-3f5cd0b2485a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
      }}
    >
      ...
      <div className="relative z-[1] mx-auto grid max-w-[1280px] items-center gap-12 lg:grid-cols-[1fr_480px]">
        <div>
          ...
          <p className="mb-7 text-[17px] leading-[1.6] text-gray-500">
          ...
          <div className="mt-7 flex flex-wrap gap-4">
            <div className="flex items-center gap-1.5 rounded-[100px] border border-gray-200 bg-white px-4 py-[7px] text-[13px] text-gray-600 shadow-[0_1px_3px_rgba(16,24,40,.06)]">
              <strong className="font-bold text-primary-600">{listings}</strong> Идэвхтэй зар
            </div>
            <div className="flex items-center gap-1.5 rounded-[100px] border border-gray-200 bg-white px-4 py-[7px] text-[13px] text-gray-600 shadow-[0_1px_3px_rgba(16,24,40,.06)]">
              <strong className="font-bold text-primary-600">{loans}</strong> Зээлээр авах боломжтой
            </div>
          </div>
        </div>
        <SearchCard />
