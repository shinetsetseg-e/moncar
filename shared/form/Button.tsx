...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  white: "!border-[1.5px] !border-white/50 !bg-white !font-bold !text-primary-600 hover:!bg-gray-50",
  "outline-white":
    "!relative !flex !h-12 !w-12 !items-center !justify-center !rounded-full !bg-[#f7f7f9] !p-0 !text-[#374151] !shadow-none !transition hover:!bg-[#eeeeF2] focus:!outline-none focus:!ring-2 focus:!ring-primary-200 focus:!ring-offset-2",
};

const baseClasses = "!inline-flex !items-center !justify-center !gap-1.5 !rounded-2xl !border-0 !font-semibold !shadow-none !transition-all !duration-150";
